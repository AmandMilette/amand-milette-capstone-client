      ...
      <main className="about-main-content">
        ...
        <section className="experience-section">
          ...
          <p className="experience-section__body">
            ...
            experience taking care of small, medium, and large-sized dogs from
            potty-trained puppies to senior cuties. I have provided dog walking,
          ...
          <p className="experience-section__body">
            ...
            out for potty breaks. I am part of the LGBTQ+ community and
            COVID-conscious (I mask indoors with KN95/N95, have up-to-date
            vaccines, and follow isolation protocols) so I will ensure that your
            pets are taken care of in my home and yours will be treated in the
            same way they are with you. I am comfortable with administering
            medication for pets, collecting mail, cleaning up pet-related
        ...
        <section className="review-section">
          ...
          <p className="review-section__body">
            ...
            with communication as we organized the housesitting and cat sitting
            details. Amand was reliable and attentive, sending regular updates.
            Our shy Charlie and Baby felt very comfortable and at home the whole
            time. We were able to enjoy our time away knowing our home and our
            beloved kitties were well-taken care of. I would absolutely
          ...
          <p className="review-section__body">
            ...
            and administering medications. Amand has experience walking and pet
            sitting young pets and seniors. They have provided in home animal
            boarding for cats and dogs while loved ones have been away on
            vacation. Amand has an eye for detail and will ensure your pet gets
            the enrichment, love, and care all in a way that meets your pet's
            lifestyle and schedule. Amand is also familiar with enrichment and
            can get your pet set up for fun using treats and a blanket to create
            an impromptu snuffle mat.
          </p>
        </section>
      </main>
    </>
